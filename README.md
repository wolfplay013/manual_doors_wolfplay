...
- **Pre-Run Shop Purchase** Allows you to buy an item from the Pre-Run Shop without needing the Pre-Run Shop item.
...
- **In Plain Sight Trap** The playet cannot hide for the next 10 doors.
