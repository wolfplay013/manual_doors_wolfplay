...
def before_create_items_filler(item_pool: list, world: World, multiworld: MultiWorld, player: int) -> list:
    ...
    # filler_items_list = ["Temporary Light-source", "Temporary Utility", "Pre-Game Shop Purchase"]
    # while not len(item_pool) >= len(multiworld.worlds[player].locations):
    #     item_pool.append({
    #             'name': random.choice(filler_items_list),
    #             'category': ["Filler Items"]
    #     })
